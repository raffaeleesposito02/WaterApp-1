...
//    let myAttrString = NSAttributedString(string: String(newsTitle[1]), attributes: myAttribute)
    ...
    let newsContent = ["This application was proposed to predict Chlorophyla_a, PH and Trans parency focused on estimating the physico-chemical parameters seen on the beach in N aples, Italy, using satellite images and Artificial Intelligence Techniques.", "Chlorophyll_a is the pigment that makes plants and algae green.  This pigment is what allows plants and algae to photosynthesize.  In photosynthesis, plants use the sun’s energy to convert carbon dioxide and water into oxygen and cellular material. Chlorophyll-a is tested in lakes to determine how much algae is in the lake.  Algae is important in lakes and beach because it adds oxygen to the water as a by-product of photosynthesis.  On the other hand, if there is too much algae in a lake it can produce a foul odor and be unpleasant for swimming, is a direct indicator used to evaluate the ecological state of a water body.", "pH indicates the sample's acidity but is actually a measurement of the potential activity of hydrogen ions (H+) in the sample. pH measurements run on a scale from 0 to 14, with 7.0 considered neutral. Solutions with a pH below 7.0 are considered acids. Solutions with a pH above 7.0, up to 14.0 are considered bases. All organisms are subject to the amount of acidity of stream water and function best within a given range. The pH scale is logarithmic, so every one-unit change in pH actually represents a ten-fold change in acidity. In other words, pH 6.0 is ten times more acidic than pH 7.0; pH 5 is one hundred times mores acidic than pH 7.0.", "Turbidity is an optical determination of water clarity 1. Turbid water will appear cloudy, murky, or otherwise colored, af fecting the physical look of the water. Suspended solids and dissolved colored mater ial reduce water clarity by creating an opaque, hazy or muddy appearance. Turbidity   measurements are often used as an indicator of water quality based on clarity and es timated total suspended solids in water."]
